...
class ProductController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		$product->pronameen = $request->get('product-name-en');
	...
	public function index()
	{
        ...
        ->select('products.id as id','products.*','products.pro_name','products.pronameen','categories.id as category_id','categories.category_name','products.pro_sort','products.created_at')
	...
	{
		$products=DB::table('products')
        ->select('products.id as id','products.*','products.slug','products.pronameen','categories.id as category_id','categories.category_name','products.pro_sort','products.created_at')
        ->leftJoin('categories','products.pro_category','=','categories.id')
	...
	//show a product
	public function show000($id)
	{
		return view('product-show')->with('product',products::find($id));
	}
	public function show($slug)
	{
		return view('product-show')->with('product',products::where('slug',$slug));
	}
	// upload images view
	...
	{
		// $products=DB::table('products')
  //       ->select('products.id as id','products.pro_name','products.pronameen','categories.id as category_id','categories.category_name','products.pro_sort','products.created_at')
  //       ->leftJoin('categories','products.pro_category','=','categories.id')
  //       //->where('categories.id', $id)
  //       ->get()
        //->paginate(2);
