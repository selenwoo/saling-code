...
class HomeController extends Controller
{
    ...
    public function show($id)
    {
        ...
        ->select('products.*','categories.id as category_id','categories.category_name','categories.category_name_en','categories.category_parent_id')
    ...
    public function about()
    {
        ...
        //products list
    public function ShowAllProducts0()
    {

        //$category=$categories->allChildrenCategorys;
        //return view('admin.products-list')->with('products',products::paginate(2));
        $categories=Category::ShowType();
        //$categories=Category::allChildrenCategorys();
        // $categories=DB::table('categories')
        // ->select('categories.id as id','categories.category_name','categories.category_name_en','childrenCategory.category_name','childrenCategory.category_name_en')
        // ->rightJoin('categories as childrenCategory','childrenCategory.category_parent_id','=','categories.id')
        // ->get();

        $products=DB::table('products')
        ->select('products.id as id','products.pro_name','products.pro_name_en','products.pro_listimg','categories.id as category_id','categories.category_name','products.pro_sort','products.created_at')
        ->leftJoin('categories','products.pro_category','=','categories.id')
        ->get();
        //->paginate(10);
        //return view('ShowAllProducts')->withProducts($products);
        return view('ShowAllProducts',compact('categories','products'));
        //return view('ShowAllProducts')->withCategories($categories);
