...
<div class="container-fluid">
                <div class="row">
                    <div class="col-md-3">
                        <div class="card p-4">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <span class="h4 d-block font-weight-normal mb-2">{{ $user_count }}</span>
                    ...
                    <div class="col-md-3">
                        <div class="card p-4">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <span class="h4 d-block font-weight-normal mb-2">{{ $products_count }}</span>
                ...
                <div class="row ">
                    ...
                    Copyright &copy; 2019 Sailing All Rights Reserved. 珠海市新霖科技有限公司 版权所有
                </div>
