...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-light">新增技术支持</div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input id="support-title" name="support-title" class="form-control" value="{{ old('support-title') }}">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="support-title-en" class="form-control-label">英文标题</label>
                                    <input id="support-title-en" name="support-title-en" class="form-control" value="{{ old('support-title-en') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="support-content" name="support-content" class="form-control" rows="12">{!! old('support-content') !!}</textarea>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="support-content-en" name="support-content-en" class="form-control" rows="12">{!! old('support-content-en') !!}</textarea>
