...
<body>
    ...
    <div class="file-box">
      <form id="uploadForm" action="{{ url('admin/image-one-upload-post') }}" method="POST" enctype="multipart/form-data">
        {!! csrf_field() !!}
        <div class="col-md-12">
          <div class="form-group">
            <label for="product-photo" class="form-control-label">产品列表图片</label>
            <input type="file" class="form-control" id="product-photo" name="product-photo" placeholder="photo" onchange="houseImgOne(this)">
