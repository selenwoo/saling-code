...
<body>
    ...
    <div class="file-box">
      <form id="uploadForm" action="{{ url('admin/pdf-one-upload-post') }}" method="POST" enctype="multipart/form-data">
        {!! csrf_field() !!}
        <div class="col-md-12">
          <div class="form-group">
            <label for="product-manual" class="form-control-label">产品说明书</label>
            <input type="file" class="form-control" id="product-manual" name="product-manual" placeholder="pdf" accept=".pdf" >
            </div>
        </div>
		  <div class="col-md-12"><button id="mybtn" class="btn btn-info">上传</button></div>
      </form>
    </div>
</body>
</html>
...
$('#mybtn').on('click', function(){
    parent.$('#product-manual').text('上传中...');
...
<script>
  ...
  function houseImgOne(_this) {
    ...
    var obj = document.getElementById("product-manual");
