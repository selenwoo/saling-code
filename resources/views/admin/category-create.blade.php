...
<div class="container-fluid">
                ...
                <div class="panel-heading">新增产品分类</div>
                    ...
                    <form action="{{ url('admin/category') }}" method="POST">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input id="category-parent" name="category-parent" class="form-control" value="<?php echo isset($_GET['pid'])?$_GET['pid']:0; ?>">
                         </div>
                         <div class="form-group">
                            <label for="category-path" class="form-control-label">路径</label>
                            <input id="category-path" name="category-path" class="form-control" name="category-path" value="<?php echo isset($_GET['path'])?$_GET['path']:'0,'; ?>" >
                         </div>
                         <div class="form-group">
