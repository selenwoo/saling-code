...
<div class="container-fluid">
                <div class="row">
                    <div class="col-md-12"><a class="btn btn-info" href="{{ url('admin/products/create') }}">添加产品</a></div>
                    <div class="col-md-12">
                        <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>{{ $product->id }}</td>
                                        <td class="text-nowrap"><a href="{{ url('products/'.$product->slug) }}" target="_blank"> {{ $product->pro_name }}</a></td>
                                        <td>{{ $product->pronameen }}</td>
